...
"前方400米，赤渊城西门。"神识体的声音再次响起，"检测到两个算力源，波动频率判定为码农境五级。他们在使用持续性的'扫描术'，覆盖范围约三十步。所有出城者的算力波动都会被捕获并比对数据库。"
...
神识体的声音没有丝毫感情波动，仿佛在陈述一条再普通不过的运行日志："扫描术的本质是遍历范围内的算力波动源，与数据库进行匹配比对。它的检测精度有一个下限阈值——低于码农境一级初期的算力波动，会被自动过滤为环境噪音。"
...
他像一个行尸走肉一样穿过最后一段暗巷，走上了通往西门的大道。城门口的火把将地面照得昏黄，两个守卫百无聊赖地站在门洞两侧，手中的扫描术化作两道淡蓝色的光圈，无声地扫过每一个经过的人。
...
"扫描完成。"神识体的声音依然冰冷，但语速比平时快了一拍，"商队第三辆马车内，有一个人——女性，码农境七级，目前因为保护平民而无法全力出手。但这不是重点。"
...
"你让我去打一头码农境四级的Bug兽？"叶辰的声音有些发紧，"我连一个正经术式都不会。"
...
女子的声音忽然压低了，带着一种不敢确认的惊疑："这不可能。神识体最早也要到调试境才能孕育。你一个码农境一级的……怎么会有神识体？"
...
"有意思。"她伸出手，"我叫苏沐橙，开源宗外门弟子，码农境七级。刚才谢了——你救了我半车货物，还有这帮不争气的护卫。"
...
她转身朝商队走去，边走边甩了甩手："收拾收拾，继续赶路！发什么愣，刚才那头Bug兽又不是我杀的——感谢我们这位码农境一级的小英雄吧！"
...
"权限不足。"他喃喃地重复了这四个字，然后抬起头，目光投向西方的夜幕深处——开源宗的方向。
